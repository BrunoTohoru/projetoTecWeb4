                ...
                <div class="container">
                    ...
                    if (isset($_GET["pesquisar"])) {
                        ...
                        if($pesquisa == null or $pesquisa == ""){
                            ...
                            $sql2 = "SELECT * FROM usuario WHERE (nome LIKE '%$pesquisa%') ORDER BY nome ASC";
                            ...
                            <?php while ($linha = mysqli_fetch_array($resultado)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="ListaUsuarios.php?id=<?= $linha['id'] ?>" class="btn btn-outline-danger" onclick="return confirm('Confirma Exclusão?')">
